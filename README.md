...
- 🌱 Currently learning Python, Django, C/C++, JavaScript, React
...
### Task Manager Web Application (In Development)
**[View Backend Code](https://github.com/fsantos23/task-manager)** | October 2024 – Present

A full-stack task management application inspired by Notion, designed as a self-hosted, open-source solution for individuals and teams.
...
**Key Features:**
- Secure JWT-based authentication with token refresh and blacklist functionality
- RESTful API endpoints for task CRUD operations
- User-specific task filtering and permissions
...
- **Methodology:** Agile with weekly sprints, Git feature-branch workflow
...
| [Transcendence](https://github.com/andrexandre/ft_transcendence) | JavaScript/Node.js, SQL | ✅ | Real-time multiplayer Pong |

### 💻 Language Distribution
- C: 9 projects
- C++: 2 projects
- Docker: 1 project
- JavaScript/Node.js: 1 project
- Full-Stack (Django/React): 1 project (ongoing)

### 🔍 Project Categories
- **Full-Stack Development**: Task Manager (ongoing)
